  ...
  liveStreamNamespace.on('connection', (socket) => {
    ...
    socket.on('getLikes', async (streamId) => {
      try {
        ...
        socket.emit('likesError', { error: 'Failed to get likes for live stream' });
      }
    });
    ...
    socket.on('postComment', async (commentData) => {
      try {
        ...
        socket.emit('commentError', { error: 'Failed to post comment on live stream' });
      }
    });
    ...
    socket.on('getComments', async (streamId) => {
      try {
        ...
        socket.emit('commentsError', { error: 'Failed to get comments for live stream' });
      }
    });
